...
newsletter.main = document.querySelector('.subsc');
newsletter.form = document.querySelector('.subsc > #singular-form');
newsletter.subs = document.querySelector('.subsc > #singular-form > button#subs');
newsletter.input = document.querySelector('.subsc>#singular-form>#email-input>input');
newsletter.submitButton = document.querySelector('.subsc > #singular-form > #email-input > button');
newsletter.successMessage = document.querySelector('.subsc > #singular-form > #success');
...
newsletter.clickHandler = (e) => {
    switch (e.target) {
        case newsletter.subs:
            ...
            newsletter.main.style.width = '28rem'
